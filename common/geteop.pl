...
#
# $Id: geteop.pl 7625 2017-01-30 09:19:04Z HelgeRottmann $
# $HeadURL: $
# $LastChangedRevision: 7625 $
# $Author: HelgeRottmann $
# $LastChangedDate: 2017-01-30 10:19:04 +0100 (Mo, 30. Jan 2017) $
#
#============================================================================


$FINALS_FILE = "usno_finals.03jul2019.erp";
...
{
        print "----------------------------------------------------------------------\n";
        print " Script to obtain EOP values from this file:\n";
	print " $FINALS_FILE\n";
